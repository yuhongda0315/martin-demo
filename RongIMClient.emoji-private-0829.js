    ...
    if (b.RongIMClient) {
        ...
        function initCss() {
            ...
            if (document.createStyleSheet) {
                initBtag = function (position) {
                    ...
                    e.style.width = '22px';
                    e.style.height = '22px';
                    e.style.backgroundImage = b["RongCloudSchemeType"] ? 'url('+ b["RongCloudSchemeType"] + b["RongOpts"]["EMOJI_BG_IMAGE"] + ')' : 'url(' + b["RongOpts"]["EMOJI_BG_IMAGE"] + ')';
                ...
                _style.innerHTML = ".RC_Expression {width:22px;height:22px;background-image:url("+ (b["RongCloudSchemeType"] ? b["RongCloudSchemeType"] + b["RongOpts"]["EMOJI_BG_IMAGE"] :b["RongOpts"]["EMOJI_BG_IMAGE"]) +");display:inline-block}";
        ...
        b.RongIMClient.Expression = new function () {
            ...
            this.retrievalEmoji = function (a, b) {
                var that = this;
                a = a.replace(/[\uf000-\uf700]/g, function (x) {
                    return that.calcUTF(x) || x;
                });
