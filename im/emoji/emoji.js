    ...
    var RongIMEmoji = (function () {
        ...
        RongIMEmoji.initCSS = function () {
            if (!document.createStyleSheet) {
                ...
                style.type = "text/css";
                style.innerHTML = ".RC_Expression {width:" + this.size + "px;height:" + this.size + "px;background-size:auto 24px;background-image:url(" + this.url + ");display:inline-block}";
        ...
        RongIMEmoji.createBTag = function (position) {
            ...
            if (document.createStyleSheet) {
                ...
                e.style.backgroundSize = "auto 24px";
