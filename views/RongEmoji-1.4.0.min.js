...
(function () {
    ...
    var RongIMEmoji = (function () {
        ...
        RongIMEmoji.init = function (emoji) {
            var me = this;
            me.url = (RongIMLib.RongIMClient && RongIMLib.RongIMClient._memoryStore && RongIMLib.RongIMClient._memoryStore.depend.emojiImage) || "//cdn.ronghub.com/css-sprite_bg-2.1.10.png";
            if (emoji) {
