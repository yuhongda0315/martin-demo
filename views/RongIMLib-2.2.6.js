(function(global, factory) {
  ...
  (function(RongIMLib) {
    var RongIMClient = (function() {
      ...
      RongIMClient.init = function(appKey, dataAccessProvider, options) {
        ...
        RongIMClient._dataAccessProvider.setServerInfo({
          navi: location.protocol + opts.navi + '/navi.xml'
        });
  ...
  (function(RongIMLib) {
    ...
    var _topic = ["invtDiz", "crDiz", "qnUrl", "userInf", "dizInf", "userInf", "joinGrp", "quitDiz", "exitGrp", "evctDiz", ["", "ppMsgP", "pdMsgP", "pgMsgP", "chatMsg", "pcMsgP", "", "pmcMsgN", "pmpMsgN"], "pdOpen", "rename", "uGcmpr", "qnTkn", "destroyChrm",
    ...
    var ConnectAck = (function(_super) {
      ...
      ConnectAck.prototype.process = function(status, userId, timestamp) {
        ...
        if (status == 0) {
          ...
          var self = this,
            temp = RongIMLib.RongIMClient._storageProvider.getItemKey("navi");
          var naviServer = RongIMLib.RongIMClient._storageProvider.getItem(temp);
          // TODO  åˆ¤æ–­æ‹†åˆ† naviServer åŽçš„æ•°ç»„é•¿åº¦ã€‚
          var naviPort = naviServer.split(",")[0].split(":")[1];
    ...
    var Navigation = (function() {
      function Navigation() {
        window.getServerEndpoint = function(x) {
          ...
          var md5Token = md5(RongIMLib.Bridge._client.token).slice(8, 16),
            openMp = x['openMp'] == 0 ? 0 : 1;
  ...
  (function(RongIMLib) {
    var ServerDataProvider = (function() {
      ...
      /*
          ...
          params.userIds : å®šå‘æ¶ˆæ¯æŽ¥æ”¶è€…
      */
  ...
  (function(RongIMLib) {
    var VCDataProvider = (function() {
      ...
      VCDataProvider.prototype.sendMessage = function(conversationType, targetId, messageContent, sendCallback, mentiondMsg, pushText, appData, methodType, params) {
        ...
        var msg = me.addon.sendMessage(conversationType, targetId, RongIMLib.RongIMClient.MessageParams[messageContent.messageName].objectName, messageContent.encode(), pushText || "", appData || "", function(progress) {}, function(message) {
      ...
      VCDataProvider.prototype.registerMessageType = function(messageType, objectName, messageTag, messageContent) {
        ...
        RongIMLib.RongIMClient.MessageParams[messageType] = {
          objectName: objectName,
          msgTag: messageTag
        };
      ...
      VCDataProvider.prototype.buildConversation = function(val) {
        ...
        if (mentions.length > 0) {
          // å–æœ€åŽä¸€æ¡ @ æ¶ˆæ¯,åŽŸå› ï¼šå’Œ web äº’ç›¸å…¼å®¹
          var mention = mentions.pop();
          conver.mentionedMsg = {
            uid: mention.messageUid,
            time: mention.sentTime,
            mentionedInfo: mention.content.mentionedInfo,
            sendUserId: mention.senderUserId
          };
        }
        return conver;
      };
  ...
  (function(RongIMLib) {
    var CookieProvider = (function() {
      ...
      CookieProvider.prototype.getItemKey = function(regStr) {
        var arrs = document.cookie.match(new RegExp("(^| )rong_navi\\w+?=([^;]*)(;|$)")),
          val = "";
        if (arrs) {
