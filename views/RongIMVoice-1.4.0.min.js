    ...
    var RongIMVoice = function() {
        ...
        RongIMVoice.init = function() {
            if (this.isIE) {
                ...
                script.src = RongIMLib.RongIMClient && RongIMLib.RongIMClient._memoryStore && RongIMLib.RongIMClient._memoryStore.depend.voiceSwfobjct || "//cdn.ronghub.com/swfobject-2.0.0.min.js";
                ...
                setTimeout(function() {
                    ...
                    swfobject.embedSWF(RongIMLib.RongIMClient && RongIMLib.RongIMClient._memoryStore && RongIMLib.RongIMClient._memoryStore.depend.voicePlaySwf || "//cdn.ronghub.com/player-2.0.2.swf", "flashContent", "1", "1", swfVersionStr, null, flashvars, params, attributes);
                }, 500);
            } else {
                var list = [ RongIMLib.RongIMClient && RongIMLib.RongIMClient._memoryStore && RongIMLib.RongIMClient._memoryStore.depend.voicePCMdata || "//cdn.ronghub.com/pcmdata-2.0.0.min.js", RongIMLib.RongIMClient && RongIMLib.RongIMClient._memoryStore && RongIMLib.RongIMClient._memoryStore.depend.voiceLibamr || "//cdn.ronghub.com/libamr-2.0.12.min.js" ];
