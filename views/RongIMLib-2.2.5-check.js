...
(function (RongIMLib) {
    var RongIMClient = (function () {
        ...
        RongIMClient.prototype.getHistoryMessages = function (conversationType, targetId, timestamp, count, callback, objectname) {
            RongIMLib.CheckParam.getInstance().check(["number", "string", "number|null|global|object", "number", "object", "undefined|object|null|global|string"], "getHistoryMessages", false, arguments);
            if (count > 20) {
    ...
    var SocketTransportation = (function () {
        ...
        SocketTransportation.prototype.createTransport = function (url, method) {
           ...
           try{
            ...
            console.log(e);
            RongIMLib.RongIMClient._storageProvider.removeItem('rongSDK');
           }
